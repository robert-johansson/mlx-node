...
impl MxArray {
    ...
    // ================================================================
    // The GenMLX consolidation ops (sigmoid/softmax/erfinv/lgamma/digamma/expm1/
    // besselI0e/besselI1e/logaddexp/nanToNum/flatten/inner/outer/diag/einsum/
    // trace + the linalg block cholesky/linalgSolve/solveTriangular/linalgInv/
    // triInv/choleskyInv/qr/svd/eigh/eigvalsh/linalgNorm) were relocated to
    // `genmlx-core/src/genmlx.rs` as module-level free fns calling the same
    // mlx-sys FFI directly (W-B) — mlx-core is stock above the substrate.
    // ================================================================
}
